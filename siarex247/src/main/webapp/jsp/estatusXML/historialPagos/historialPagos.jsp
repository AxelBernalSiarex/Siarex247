	    ...
	    $.ajax({
	        ...
	        success  : function(data) {
	            if(!$.isEmptyObject(data)) {
	                ...
	                if(document.getElementById("HISTORIAL_PAGOS_TITLE1"))
	                    document.getElementById("HISTORIAL_PAGOS_TITLE1").innerHTML = data.TITLE1;

	                // Texto del botÃ³n âOpcionesâ si lo usas en el JSP
	                if(document.getElementById("HISTORIAL_PAGOS_BTN_OPCIONES"))
	                    document.getElementById("HISTORIAL_PAGOS_BTN_OPCIONES").innerHTML = data.BTN_OPCIONES || "Opciones";

	                // Encabezados de tabla
	                if(document.getElementById("HISTORIAL_PAGOS_ETQ1")) document.getElementById("HISTORIAL_PAGOS_ETQ1").innerHTML = data.ETQ1;
	                if(document.getElementById("HISTORIAL_PAGOS_ETQ2")) document.getElementById("HISTORIAL_PAGOS_ETQ2").innerHTML = data.ETQ2;
	                if(document.getElementById("HISTORIAL_PAGOS_ETQ3")) document.getElementById("HISTORIAL_PAGOS_ETQ3").innerHTML = data.ETQ3;
	                if(document.getElementById("HISTORIAL_PAGOS_ETQ4")) document.getElementById("HISTORIAL_PAGOS_ETQ4").innerHTML = data.ETQ4;
	                if(document.getElementById("HISTORIAL_PAGOS_ETQ5")) document.getElementById("HISTORIAL_PAGOS_ETQ5").innerHTML = data.ETQ5;
	                if(document.getElementById("HISTORIAL_PAGOS_ETQ6")) document.getElementById("HISTORIAL_PAGOS_ETQ6").innerHTML = data.ETQ6;
	                if(document.getElementById("HISTORIAL_PAGOS_ETQ7")) document.getElementById("HISTORIAL_PAGOS_ETQ7").innerHTML = data.ETQ7;

	                // TÃ­tulo del modal (si lo tienes con este id)
	                if(document.getElementById("HISTORIAL_PAGOS_MODAL_TITULO"))
	                    document.getElementById("HISTORIAL_PAGOS_MODAL_TITULO").innerHTML = data.MODAL_TITULO || "Cargar Archivo";

	              
	                if(document.getElementById("btnRefresh_HistorialPagos")) {
	                    document.getElementById("btnRefresh_HistorialPagos").innerHTML =
	                        '<span class="fab fa-firefox-browser me-1" data-fa-transform="shrink-3 down-2"></span>' +
	                        '<span class="d-none d-sm-inline-block ms-1">'+ BTN_REFRESCAR +'</span>';
	                }
	            }
	        },

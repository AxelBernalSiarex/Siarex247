...
public class ValidarXMLQuerys {
	...
	private static String detalleXMLInd =  "select EMISOR_RFC, EMISOR_NOMBRE, SUB_TOTAL, TOTAL, DES_TIPO_MONEDA, ESTADO_SAT, ESTATUS_SAT, SERIE, FOLIO from INFORMACION_XML where ID_EMPLEADO = ? order by EMISOR_NOMBRE asc, TIPO_MONEDA asc";
